          ...
          <div className="mt-5 flex flex-col gap-3 rounded-2xl border border-slate-100 bg-white/80 p-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-1 text-xs leading-5 text-slate-600">
                Safely remove only completed, failed, and rejected runs. Active
                approval, retrying, executing, and approval-processing runs are
                skipped.
              </p>
            ...
            <button
              ...
              disabled={safeCleanupLoading || Boolean(actionRunId) || Boolean(deleteRunId)}
                      ...
                      >
                                ...
                                <div className="mt-3 rounded-xl border border-blue-100 bg-white p-3">
                                  ...
                                  {approvalStatus ===
                                    ...
                                    <div className="mt-3 rounded-lg border border-red-100 bg-red-50 p-3 text-xs leading-5 text-red-700">
                                      ...
                                      active for too long and stopped the
                                      workflow safely to prevent duplicate
                                      execution.
                                    </div>
                                  )}
                        ...
                        <div className="mt-4 flex flex-col gap-3 rounded-2xl border border-slate-100 bg-white p-4 md:flex-row md:items-center md:justify-between">
                          <div>
                            ...
                            <p className="mt-1 text-xs leading-5 text-slate-600">
                              Delete this saved workflow run from local history
