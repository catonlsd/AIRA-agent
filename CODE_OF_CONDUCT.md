...
We as members, contributors, and leaders pledge to make participation in the AIRA-X
...
the maintainers responsible for enforcement via a private GitHub Security Advisory or the
contact listed in [SECURITY.md](SECURITY.md). All complaints will be reviewed and
